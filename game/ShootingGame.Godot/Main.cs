...
/// <summary>
/// ShootingGame の Godot 層エントリポイント。描画・入力・Statee 配線だけを担い、
/// ゲームルールはすべて ShootingGame.Logic に置く(docs/USING.md「境界の掟」)。
/// </summary>
public partial class Main : Node2D
{
    ...
    public override void _Draw()
    {
        ...
        DrawString(
            ...
            new Vector2(16, 32),
            $"ShootingGame  seed={_logic.Seed}  step={_logic.StepCount}",
            fontSize: 20
        );
    }
